...
# MODELO
base_model = MobileNetV2(input_shape=(224, 224, 3), include_top=False, weights='imagenet')#include top false para crear nuestras propias clases
...
model = models.Sequential([
    ...
    layers.Dense(3, activation='softmax')  # Cambia el número si tienes más o menos clases
])
